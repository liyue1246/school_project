...
$sql	=	"SELECT * FROM `user_data` limit 1";
...
foreach ($result as $row)
{
    ...
    <script>
        ...
        post('/manage/Views/admin_delect.php', {'myid':myid});
    ...
    <script>
    	function change$i(){var myId=document.getElementById("$i").cells[1].innerHTML;
                            ...
                            post('/manage/Views/admin_change.php', {'myId':myId,'myName':myName,'myPasswd':myPasswd,'myPerson_tel':myPerson_tel,'myUrget_tel':myUrget_tel,'myAddress':myAddress});}
    </script>
END;
$i=$i+1;     
}
